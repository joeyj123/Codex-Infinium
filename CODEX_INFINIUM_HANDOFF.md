...
- **Running total: 260 Anvil challenges across Apprentice (up from 242), 55 empty topics remain** (down from 61) — next batches should continue in topic order through the rest of Language Fundamentals, then Language Survey, Data Structures, etc.
